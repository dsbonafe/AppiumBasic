...
public abstract class Helpers {
	 ...
	 */
	public static AndroidElement element(By locator) {
	 ...
	 */
	public static AndroidElement s_text(int xpathIndex) {
	 ...
	 */
	public static AndroidElement text(String text) {
	 ...
	 */
	public static AndroidElement text_exact(String text) {
	...
	public static AndroidElement find(String value) {
		return element(for_find(value));
	}
	
	public static AndroidElement find(By locator) {
